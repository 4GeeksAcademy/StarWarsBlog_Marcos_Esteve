		...
		<nav className="navbar navbar-light" style={{backgroundColor: "#f5f7fa"}}>
			...
			<div className="ml-auto">
				<div className="dropdown">
					<button className="btn btn-success dropdown-toggle mx-4" type="button" data-bs-toggle="dropdown" aria-expanded="false">
						Favorites
					</button>
							...
							store.favorites.map((elemento, index) => (
								<li key={index}>
									<div className="d-flex justify-content-between justify-content-between align-items-center">
										...
										<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-trash2-fill mx-3" viewBox="0 0 16 16" onClick={(event)=> trash_botton(event,elemento)}>
