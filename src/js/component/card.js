        ...
        <div className="card mx-2" style={{  backgroundColor: "#2e3b44", width: "18rem", boxShadow: "0 6px 20px rgba(0, 0, 0, 0.5)", border: "1px solid #c5a100" }}>
            ...
            <div className="card-body text-white">
                ...
                <div className="d-flex justify-content-between mt-2">
                    ...
                    <button className="btn btn-success" onClick={()=> boton_icono()}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
